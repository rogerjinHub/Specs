#
#  Be sure to run `pod spec lint realFramework.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.version      = "1.0.1"
  s.summary      = "This is the universal real framework"

  s.description  = <<-DESC
                   A longer description of realFramework in Markdown format.
  ...
  s.source       = { :git => "https://github.com/rogerjinHub/realFramework.git", :tag => "1.0.1" }
